## V3.1：所有已完成題庫上線，立即自由選關

依使用者要求，Day 1–35 已全部納入正式網站，合計 225 道每日閱讀題。新使用者也能立即進入 Day 35，不再等待日期解鎖。首頁提供直接選關、本篇全部題目、官方歷屆 215 題與相似練習 10 題的入口。

目前共可使用 450 題：225 題每日原創閱讀、215 題官方答案卡（搭配官方原題本）、10 題原創相似練習。**250 天是課程目標；Day 36–250 尚未完成，不能標示「250 天全題庫已完成」。** 不同區域的題目與成績仍分開保存。

Day 13–35 以 `content/releases/2026-09-14-day-013-035.json` 批次發布；清單固定來源雜湊，建置時驗證每份內容。沒有改寫原文、選項順序、答案或題目 ID，也沒有偽造未來的每日發布檔。每日提醒可引用已上線的對應文章，避免再建立同一 Day。
...
- 此批共 23 篇、147 題；連同 Day 1–12，已上線總數為 35 篇、225 題。
