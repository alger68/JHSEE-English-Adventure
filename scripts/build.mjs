...
const meta={version:'3.3.0',revision,lessonCount:lessons.length,questionCount,targetLessonCount:250,accessMode:'all-published',lastPublishDate,lastDailyPublishDate};
